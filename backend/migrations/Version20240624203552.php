 ...
 */
final class Version20240624203552 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comics (id INT NOT NULL, title VARCHAR(255) NOT NULL, picture TEXT NOT NULL, pdf TEXT NOT NULL, upload_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
    }
